...
export default function Main() {
  return (
    <section className='flex flex-row w-full mx-auto space-y-4 px-4 mt-32 mb-20 '>
      ...
      <div className=''>
        <NextImage
          ...
          width={224}
          height={224}
          className='h-56 w-56 rounded-full backdrop-blur-sm shadow-cyan-400 shadow-lg bg-black'
        />
      </div>
    </section >
  )
