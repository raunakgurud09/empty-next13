  ...
  return (
    <div className="flex flex-col md:flex-row">
      ...
      <div className="w-full md:ml-2 md:w-10/12">
        ...
        <p className="font-extralight">Lorem ipsum dolor sit amet consectetur adipisicing elit. Atque, aspernatur alias, debitis cumque ducimus obcaecati tempore numquam dicta, veritatis expedita maiores. Aliquid repellendus sint sunt? Sint iure deleniti dicta praesentium.</p>
