...
description: "This blog post explores the process of dockerization a TypeScript Express app while taking into consideration best practices. It showcases the usage of multistage Docker files to optimize the Dockerization process."
image: "/images/blog/multistage/thumbnail-1.png"
date: 2023-01-19
authors:
  - raunak
  - shadcn
...
![setup-basic-express](/images/blog/multistage/setup-basic-express-app.png)
...
![setup-package-json](/images/blog/multistage/setup-package-json.png)
...
![setup-console](/images/blog/multistage/setup-console.png)
...
![setup-health](/images/blog/multistage/setup-health.png)
...
![setup-dockerignore](/images/blog/multistage/setup-docker.png)
...
![docker-image-explain](/images/blog/multistage/docker-image-explain.png)
...
![build-console-single](/images/blog/multistage/build-console-single.png)
...
![run-console-single](/images/blog/multistage/run-console-single.png)
...
![size-single](/images/blog/multistage/size-single.png)
...
![multi-stage-process-1](/images/blog/multistage/multi-stage-process-1.png)
...
![multi-stage-process-2](/images/blog/multistage/multi-stage-process-2.png)
...
![dockerfile-multi](/images/blog/multistage/dockerfile-single.png)
...
Output:
![build-console-multistage](/images/blog/multistage/build-console-multistage.png)
...
![run-console-multi](/images/blog/multistage/run-console-multi.png)
...
![size-multi](/images/blog/multistage/size-multi.png)
...
![dockerfile-alpine](/images/blog/multistage/dockerfile-alpine.png)
...
![build-console-alpine](/images/blog/multistage/build-console-alpine.png)

Now, let's take a look at the size of the image

![size-alpine](/images/blog/multistage/size-alpine.png)

Yaayy!!! 🥳🥳 as you can see the size of the image is now 147 MB from 1.1 GB

![size-all](/images/blog/multistage/size-all.png)
